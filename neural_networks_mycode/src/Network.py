...
class Network(object):
    ...
    # test function
    # print every parameter of every layers, 
    # so as to provide a better understanding of the whole neural network
    def sayHello(self):
    ...
    def SGD(self,training_data,epoches,mini_batch_size,eta,test_data=None):
        ...
        after eachepoch, and partial progress printed out.  
        ...
        # training_data1 = list(training_data)
        n = len(training_data)
        # range生成数组，而xrange生成“生成器”，但是用法一致
        # 在python3.5中，range和xrange合并
...
# standard activition function --- sigmoid
